...
for loc in locations:
    for when in years:
        ...
        da = xr.open_mfdataset("*_reanalysis-era5-single-levels.nc", parallel=True)
    ...
    df_out = df3[['time', 't2m','d2m', 'u10', 'v10', 'ssrd']]
    print(df_out.head())
    print(df_out.tail())
    # df_out['time'] = pd.to_datetime(df_out['time'])
    df_out.to_csv( "/home/bsurya/Projects/air_model/data/era5/" + loc + "20" + ".csv")
